    ...
    def upload(package, remote_files):
        ...
        for name, details in files.items():
            ...
            if "yyyy" in name and "yyyy" in details["url"]:
                ...
                urls = [url[1] for url in misc_utils.parse_possible_filepaths(details["url"])]
...
default_args = airflow_utils.get_default_args(
    {"on_failure_callback": send_failure_msg, "start_date": job_settings["start_date"], "email": "mackenzie.nichol4@toronto.ca", "owner": "Mackenzie"}
)
