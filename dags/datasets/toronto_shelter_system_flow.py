...
with DAG(
    ...
    validate = PythonOperator(
        task_id="validate_expected_columns",
    ...
    create_tmp_dir >> source_data >> transform >> validate

    validate >> new_data_unique_id >> is_data_new_branch
    ...
    transform >> validate >> resource_is_new
    ...
    [validate, resource] >> is_file_new_branch
